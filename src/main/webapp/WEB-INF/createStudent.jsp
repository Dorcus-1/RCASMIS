...
<div class="container">
  ...
  <form  action="createstudent.php?page=createstudent" method="post">
    ...
    <input type="number" placeholder="Is international" required name="international">
    <input type="number" placeholder="Is parttime" required name="ptime">
    <input type="number" placeholder="Is repeating" required name="repeating">
